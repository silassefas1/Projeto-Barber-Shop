...
dependencies {
	...
	implementation("org.mapstruct:mapstruct:${mapStrucVersion}")
	...
	annotationProcessor("org.mapstruct:mapstruct-processor:${mapStrucVersion}")
